...
public class AllocateUserHibernateDao extends GenericHibernateDAO<AllocateUser, Long>
    ...
    public List<AllocateUser> getAllocateUser() {
        ...
        try {
            ...
            String query = "Select lu.userid, lu.username from la_ext_user lu inner join la_ext_userrolemapping lm on lu.userid = lm.userid where lm.roleid = 4 order by lu.userid";
