 ...
 *
 */
public interface SpatialUnitResourcePointDao extends GenericDAO<SpatialUnitResourcePoint, Long> {
     ...
     * @return
     */
    SpatialUnitResourcePoint addSpatialUnitResourcePoint(SpatialUnitResourcePoint spatialUnit);
    ...
    BasicResourcePoint getBasicResourcePoint(Long landid);
    
    BasicResourcePoint saveBasicResourcePoint(BasicResourcePoint point);
}
