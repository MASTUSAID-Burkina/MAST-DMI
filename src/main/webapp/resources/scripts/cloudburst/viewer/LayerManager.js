                ...
                for (x in projects.projectLayergroups) {
                    ...
                    for (y in projects.projectLayergroups[x].layergroupBean.layerLayergroups) {
                        ...
                        if (projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.editable) {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_editable").attr('title', $.i18n('layer-editable'));
                        } else {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_editable").attr('title', $.i18n('layer-noneditable'));
                        }
                        ...
                        if (projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.selectable) {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_selectable").attr('title', $.i18n('layer-selectable'));
                        } else {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_selectable").attr('title', $.i18n('layer-nonselectable'));
                        }
                        ...
                        if (projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.queryable) {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_queryable").attr('title', $.i18n('layer-queryable'));
                        } else {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_queryable").attr('title', $.i18n('layer-nonqueryable'));
                        }
                        ...
                        if (projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.exportable) {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_exportable").attr('title', $.i18n('layer-exportable'));
                        } else {
                            ...
                            $("#" + projects.projectLayergroups[x].layergroupBean.layerLayergroups[y].layers.alias + "_exportable").attr('title', $.i18n('layer-nonexportable'));
                        }
